...
public class OptionDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void onAttach(Context context){
        ...
        if (fragment instanceof  DetaiCategoryFragment){
            DetaiCategoryFragment detaiCategoryFragment =(DetaiCategoryFragment) fragment;
            this.optionDialogListener = detaiCategoryFragment.optionDialogListener;
